 ...
 */
export function generateFingerprint(publicKeyBytes) {
...
export async function generateRSAKeyPair(userId) {
...
export async function encryptWithPublicKey(plaintext, publicKeyArmored) {
    ...
    const importedKey = await crypto.subtle.importKey('spki', bytes.buffer, { name: 'RSA-OAEP', hash: 'SHA-256' }, false, ['encrypt']);
