 ...
 */
export function detectHomographDomain(domain) {
 ...
 */
export function evaluateLinkDeception(href, anchorText) {
 ...
 */
export function scanForPhishing(paramOrText, html, from) {
