 ...
 */
export function clampPaneDimensions(proposed, totalContainerWidth, totalContainerHeight, constraints = DEFAULT_LAYOUT_CONSTRAINTS) {
 ...
 */
export function computeLayoutGridStyles(state, containerWidth) {
