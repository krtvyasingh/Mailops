 ...
 */
export function injectSignature(body, signature, format = 'html', position = 'above-quote') {
 ...
 */
export function extractSignature(body, isHtml = false) {
    if (!body)
        return { cleanBody: '', extractedSignature: null };
    if (isHtml) {
