 ...
 */
export function getCurrentMinutesInTimezone(date = new Date(), timezone = 'UTC') {
    try {
 ...
 */
export function isMinuteInWindow(currentMin, startMin, endMin) {
    if (startMin === endMin) {
 ...
 */
export function evaluateDndStatus(config, notification, evalDate = new Date()) {
